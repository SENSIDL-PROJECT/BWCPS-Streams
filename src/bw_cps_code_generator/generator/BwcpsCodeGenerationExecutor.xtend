...
import bw_cps_code_generator.generator.job.GenerationJobFactory
 ...
 */
class BwcpsCodeGenerationExecutor implements IBwcpsCodeGenerator {

	private static Logger logger = Logger.getLogger(BwcpsCodeGenerationExecutor)
