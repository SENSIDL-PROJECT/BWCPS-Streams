 ...
 * @generated
 */
public class SourceNodeTypeItemProvider extends NodeTypeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SourceNodeTypeItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SourceNodeType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SourceNodeType"));
	}
	...
	public String getText(Object object) {
		String label = ((SourceNodeType) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_SourceNodeType_type")
				: getString("_UI_SourceNodeType_type") + " " + label;
	}
