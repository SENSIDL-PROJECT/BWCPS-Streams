...
public class operationsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case operationsPackage.PROPERTY: {
		...
		case operationsPackage.AGGREGATING: {
			Aggregating aggregating = (Aggregating) theEObject;
			T result = caseAggregating(aggregating);
			if (result == null)
				result = caseProperty(aggregating);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case operationsPackage.COMPOSITIONELL_OPERATION: {
			CompositionellOperation compositionellOperation = (CompositionellOperation) theEObject;
			T result = caseCompositionellOperation(compositionellOperation);
			if (result == null)
				result = caseOperation(compositionellOperation);
			if (result == null)
				result = caseNamedElement(compositionellOperation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case operationsPackage.MAPPING: {
			...
			if (result == null)
				result = caseOperationType(mapping);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case operationsPackage.SELECTING: {
			Selecting selecting = (Selecting) theEObject;
			T result = caseSelecting(selecting);
			if (result == null)
				result = caseProperty(selecting);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case operationsPackage.ATOMIC_OPERATION: {
			...
			if (result == null)
				result = caseOperation(atomicOperation);
			if (result == null)
				result = caseNamedElement(atomicOperation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case operationsPackage.PROJECTION: {
			...
			if (result == null)
				result = caseOperationType(projection);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case operationsPackage.OPERATION_TYPE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Aggregating</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Aggregating</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAggregating(Aggregating object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Compositionell Operation</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Compositionell Operation</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCompositionellOperation(CompositionellOperation object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Selecting</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Selecting</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSelecting(Selecting object) {
		return null;
	}
